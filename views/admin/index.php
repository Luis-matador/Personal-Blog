...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <!-- Botón de cerrar sesión de admin -->
    <div class="mt-8 text-center">
        <a href="<?= url('admin/logout') ?>" class="inline-flex items-center gap-2 px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-semibold shadow-lg">
